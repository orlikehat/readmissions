...
def f_preprocess_blood_coag():
    path = "C:/Users/orlyk/readmissions/project/preprocessed/labs/blood_coagulation/blood_coag_preprocessed"
...
#                    df_fin=df_fin.drop(columns=["temp_first","temp_min","temp_last","temp_max"])
    ...
    for file in files:
        ...
        df_blood_coag=pd.merge(df_blood_coag,df,how="outer",on="CaseNum")
    ...
    df_blood_coag_results_only= df_blood_coag.filter(regex=r'(result|CaseNum)')
    
    df_blood_coag.to_pickle(r"C:\Users\orlyk\readmissions\project\preprocessed\labs\blood_coagulation\blood_coag_for_model\blood_coag_results_with_dates.pkl")
    df_blood_coag_results_only.to_pickle(r"C:\Users\orlyk\readmissions\project\preprocessed\labs\blood_coagulation\blood_coag_for_model\blood_coag_results_only.pkl")
    
    return df_blood_coag_results_only
